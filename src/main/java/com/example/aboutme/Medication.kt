...
class Medication: AppCompatActivity()  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val bottomNavigationView =
            findViewById<BottomNavigationView>(R.id.bottomNavigationMedication)
    ...
    private fun writeSelectedBoxes()
    {
        ...
        {
            prefs.writeData(date, "medication",
                "medication", selectedBoxes.joinToString("+"))
        }
    }
        ...
        else
        {
            ...
            for (med in existingBoxes.split(","))
            {
                ...
                val checkBox = CheckBox(
                    ContextThemeWrapper(this, R.style.medicationCheckBox))
                ...
                val deleteButton = ImageButton(
                    ContextThemeWrapper(this, R.style.crossButton))
        ...
        val builder = AlertDialog.Builder(this)
            ...
            .setPositiveButton("Add",
                ...
                DialogInterface.OnClickListener { _, _ ->
                    ...
                    {
                        Toast.makeText(this,"Name must be alphanumeric",
                    ...
                    if (dose != "")
                    {
                        ...
                        {
                            Toast.makeText(this,
                                "You can leave the dose blank, or it must " +
                                        "be a whole number",
                                Toast.LENGTH_SHORT).show()
                            return@OnClickListener
                        }
                    ...
                    if (frequency != "")
                    {
                        ...
                        {
                            Toast.makeText(this,
                                "You can leave the frequency blank, or it must " +
                                        "be alphanumeric",
                                Toast.LENGTH_SHORT).show()
                            return@OnClickListener
                        }
                    }
                    if ("$name#$dose#${frequency.toLowerCase()}" in medication.keys)
                    {
                        Toast.makeText(this,"You have already " +
                                "added this medication.",
                            Toast.LENGTH_SHORT).show()
                        return@OnClickListener
                    }
